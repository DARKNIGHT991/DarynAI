...
def chat_with_ai(req: ChatRequest):
    ...
    def generate_stream():
        ...
        system_instruction = (
            ...
            "\n\nСТИЛЬ ОБЩЕНИЯ:"
            "\n- Будь вежливым, приветливым и интеллектуальным."
            "\n- Обязательно отвечай на приветствия (Привет, Hello, Сәлем) дружелюбно и СТРОГО на языке пользователя."
            "\n- Избегай роботизированных ответов вроде 'Приветственную фразу не понял'. Будь живым собеседником."
